        ...
        <div class="home_slider_container">
            ...
            <div class="owl-carousel owl-theme home_slider">
                ...
                <div class="owl-item home_slider_item">
                    <div class="home_slider_background" style="background-image:url(/online_shop/images/home_slider_1.jpg)"></div>
    ...
    <div class="avds">
        <div class="avds_container d-flex flex-lg-row flex-column align-items-start justify-content-between">
            <div class="avds_small">
                <div class="avds_background" style="background-image:url(/online_shop/images/avds_small.jpg)"></div>
            ...
            <div class="avds_large">
                <div class="avds_background" style="background-image:url(/online_shop/images/avds_large.jpg)"></div>
