...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>B</b>aa</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>B</b>aa<b>B</b>aa</span>
        </a>
                ...
                <li class="active treeview">
                    ...
                    <#--<li class="active"><a href="#"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>-->
                        <#--<@shiro.hasPermission name="read article">-->
                            <li><a href="javascript:;" data-url="to_product_list"><i class="fa fa-circle-o"></i>商品列表</a></li>
                            <li><a href="javascript:;" data-url="to_add_product"><i class="fa fa-circle-o"></i>添加商品</a></li>
                            <li><a href="javascript:;" data-url="to_product_category"><i class="fa fa-circle-o"></i>商品分类</a></li>
                            <li><a href="javascript:;" data-url="to_product_attribute_category"><i class="fa fa-circle-o"></i>商品类型</a></li>
                        <#--</@shiro.hasPermission>-->
                    </ul>
                </li>
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="javascript:;" data-url="#"><i class="fa fa-circle-o"></i>订单列表</a></li>
                        <li><a href="javascript:;" data-url="#"><i class="fa fa-circle-o"></i>订单设置</a></li>
                        <li><a href="javascript:;" data-url="#"><i class="fa fa-circle-o"></i>退货申请处理</a></li>
                        <li><a href="javascript:;" data-url="#"><i class="fa fa-circle-o"></i>退货原因设置</a></li>
                    </ul>
                </li>
                <li class="active treeview">
                    <a href="#">
                    ...
                    <#--<@shiro.hasPermission name="read user">-->
                        <li><a href="javascript:;" data-url="admin/to_admin_user_list"><i class="fa fa-circle-o"></i>账户管理</a></li>
                    <#--</@shiro.hasPermission>-->
